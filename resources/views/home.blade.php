                        ...
                        <table class="table table-bordernone">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="button btn btn-primary">Done<i class="fa fa-check-circle ml-2"></i>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
            ...
            <div class="card bg-img">
                ...
                <div class="card-body">
                    <div class="body-bottom">
                        <h6> 10% off For drama lights Couslations...</h6><span class="font-roboto">Lorem Ipsum is simply
                            dummy...It is a long established fact that a reader will be distracted by </span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card chat-default">
        ...
        <div class="card-body chat-box">
            <div class="chat">
                ...
                <div class="media right-side-chat">
                    <div class="media-body text-right">
                        <div class="message-main pull-right"><span class="loader-span mb-0 text-left" id="wave"><span
